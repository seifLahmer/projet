...
public class Coach extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Button foodButton = createButtonWithIcon("Food", "/food.png", "/FoodView.fxml");
        Button dietButton = createButtonWithIcon("Diet", "/diet.png", "/DietView.fxml");
        Button activitiesButton = createButtonWithIcon("Activités", "/activities.png", "/ActivitiesView.fxml");
