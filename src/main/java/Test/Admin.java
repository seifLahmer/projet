...
public class Admin extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Label placeholderContent = new Label("Welcome to the Admin Interface");
    ...
    // Method to open Admin Interface from Main
    public static void openAdminInterface() throws Exception {
        Admin adminInterface = new Admin();
        Stage stage = new Stage();
        adminInterface.start(stage); // Start Admin interface
    }
}
